...
- [ ] Same-environment numerical preservation verified, or intended differences
      and their scientific justification documented without hiding warnings
- [ ] Dependency changes are deliberate and update both uv and native conda inputs
- [ ] No secrets, private datasets, or notebook execution outputs included
- [ ] Contribution follows `CODE_OF_CONDUCT.md` and preserves license attribution
